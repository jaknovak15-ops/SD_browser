...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.sort_by_name = False  # přepínání řazení: False = datum, True = název
        ...
        self.btn_sort_toggle = QtWidgets.QPushButton("by date")
        btn_row.addWidget(self.btn_select_files)
        btn_row.addWidget(self.btn_select_folder)
        btn_row.addWidget(self.btn_reset)
        btn_row.addWidget(self.btn_sort_toggle)
        ...
        mid_panel.setFixedSize(620, 620)
        ...
        self.preview.setFixedSize(620, 620)
        ...
        self.btn_sort_toggle.clicked.connect(self.toggle_sorting)
    ...
    def select_files(self):
        paths, _ = QtWidgets.QFileDialog.getOpenFileNames(
            self, "Vyber obrázky", "", "Obrázky (*.png *.jpg *.jpeg *.webp)"
        )
        if paths:
    ...
    def toggle_sorting(self):
        ...
        if self.sort_by_name:
            self.btn_sort_toggle.setText("by Name")
        else:
            self.btn_sort_toggle.setText("by Date")
        self.apply_sorting()
